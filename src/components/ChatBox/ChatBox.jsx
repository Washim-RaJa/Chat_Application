...
const Chatbox = () => {
  const {userData, chatUser, messages, messagesId, setMessages, chatVisible, setChatVisible} = useContext(AppContext);
        ...
        userIDs.forEach(async(id)=>{
          ...
          if (userChatsSnapshots.exists()) {
            ...
            if (userChatData.chatsData[chatIndex].rId === userData.id) {
              userChatData.chatsData[chatIndex].messagesSeen = false
            }
  ...
  return chatUser ? (
    <div className={`chat-box ${chatVisible ? "" : "hidden"}`}>
        <div className="chat-user">
            ...
            <img className='help' src={assets.help_icon} alt="help_icon" />
            <img onClick={()=> setChatVisible(false)} src={assets.arrow_icon} className='arrow' alt="arrow_icon" />
        </div>
        <div className="chat-msg">
          {messages.map((msg, idx)=> (
            <div key={idx} className={msg.sId === userData.id ? "s-msg" : "r-msg"}>
              { msg["image"]
                ? <img className='msg-img' src={msg.image} alt="chat-image" />
                : <p className="msg">{msg.text}</p>
              }
              <div>
                <img src={msg.sId === userData.id ? userData.avatar : chatUser.userData.avatar} alt="profile_image" />
